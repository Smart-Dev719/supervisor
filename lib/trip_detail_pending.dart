...
class _TripDetailPendingState extends State<TripDetailPending>
  ...
  @override
  void initState() {
    print("ddddd" + widget.trip.toString());
    getDriver();
    getBusSize();
    getBus();
    super.initState();
  ...
  getDriver() async {
    ...
    print("drivername" + driverList_ids.toString());
    print("drivername2" + driverList.toString());
  }
  ...
  Future<bool> editDailyTrip(String status) async {
    ...
    if (response.statusCode == 200) {
      ...
      print("editDailyTrip" + responseJson.toString());
    }
    return false;
  }
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<List<void>>(
      ...
      builder: (context, snapshot) {
        if (snapshot.hasData) {
          print("asd:" + driver.toString());
          print("fgh:" + busSize.toString());
          print("jkl:" + bus.toString());
          // driverList.clear();
          // busNoList.clear();
          // busSizeList.clear();
